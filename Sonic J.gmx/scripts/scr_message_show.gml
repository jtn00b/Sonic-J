...
check = argument3;
instance_create(0,0,obj_mp_controller);
instance_create(0,0,obj_mp_ribbon);
title_obj = instance_create(0,0,obj_mp_title);
text_obj = instance_create(0,0,obj_mp_text);
...
switch(check){
    default:
    case 0:
        ok = instance_create(0,0,obj_mp_ok);
        break;
    case 1:
        global.accepted = -1;
        yes = instance_create(0,0,obj_mp_yes);
        no = instance_create(0,0,obj_mp_no);
